...
//         return newPosition % (allProducts.length * 100);
//       });
//     }, 50);
...
//       <div className="flex flex-col md:flex-row justify-between items-start md:items-start text-center md:text-left mb-12">
//         <h2 className="text-3xl md:text-4xl font-bold w-full">Trending Products.</h2>
...
//           <button className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 text-gray-700 text-4xl">
//             &lt;
//           </button>
...
//           <button className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 text-gray-700  text-4xl">
//             &gt;
//           </button>
//         </div>
//       </div>
